...
void serialMenuCommon()
{
    ...
    if(configPage == MENU_SERVO) {
        switch(COL) {
        case 1:
            servo.settings[0][ROW-1]+= menudir;
            break;
        case 2:
            servo.settings[1][ROW-1]+= menudir;
            break;
        case 3:
            servo.settings[2][ROW-1]+= menudir;
            break;
        }
    }
#endif
    ...
    if (configPage == MENU_FIXEDWING && COL == 3) {
        switch(ROW) {
        case 1:
            cfg.fw_gps_maxcorr += menudir;
            break;
        case 2:
            cfg.fw_gps_rudder += menudir;
            break;
        case 3:
            cfg.fw_gps_maxclimb += menudir;
            break;
        case 4:
            cfg.fw_gps_maxdive += menudir;
            break;
        case 5:
            cfg.fw_climb_throttle += menudir;
            break;
        case 6:
            cfg.fw_cruise_throttle += menudir;
            break;
        case 7:
            cfg.fw_idle_throttle += menudir;
            break;
        case 8:
            cfg.fw_rth_alt += menudir;
            break;
        }
    }
#endif
    ...
    if (configPage == MENU_VOLTAGE && COL == 3) {
        switch(ROW) {
        case 1:
            ModifySetting(S_VOLTAGEMIN)
        case 2:
            ModifySetting(S_DIVIDERRATIO)
        case 3:
            ModifySetting(S_VIDDIVIDERRATIO)
        case 4:
            ModifySetting(S_BATCELLS)
        }
    }
#endif
    ...
    if (configPage == MENU_RSSI && COL == 3) {
        ...
        case 1:
            timer.rssiTimer=15;
            break; // 15 secs to turn off tx and wait to read min RSSI
        case 2:
            ModifySetting16(S16_RSSIMAX)
        case 3:
            ModifySetting16(S16_RSSIMIN)
        }
    }
#endif
    ...
    if (configPage == MENU_CURRENT && COL == 3) {
        switch(ROW) {
        case 1:
            ModifySetting16(S16_AMPDIVIDERRATIO)
        case 2:
            ModifySetting16(S16_AMPZERO)
        }
    }
#endif
    ...
    if (configPage == MENU_ADVANCED && COL == 3) {
        switch(ROW) {
        case 1:
            timer.magCalibrationTimer=CALIBRATION_DELAY;
            break;
        case 2:
            ReverseSetting(S_THROTTLE_PWM)
        }
    }
#endif
    ...
    if (configPage == MENU_GPS_TIME && COL == 3) {
        switch(ROW) {
        case 1:
            ReverseSetting(S_GPSTIME);
        case 2:
            ReverseSetting(S_GPSTZAHEAD);
        case 3:
    ...
    if (configPage == MENU_ALARMS && COL == 3) {
        switch(ROW) {
        case 1:
            ModifySetting(S_DISTANCE_ALARM)
        case 2:
            ModifySetting(S_ALTITUDE_ALARM)
        case 3:
            ModifySetting(S_SPEED_ALARM)
        case 4:
            ModifySetting(S_FLYTIME_ALARM)
        case 5:
            ModifySetting(S_AMPER_HOUR_ALARM)
        case 6:
            ModifySetting(S_AMPERAGE_ALARM)
        case 7:
            ReverseSetting(S_ALARMS_TEXT)
        }
    }
#endif
